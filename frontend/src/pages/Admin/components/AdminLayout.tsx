...
const tabs = [
  { to: "/admin", label: "Overview", icon: <BarChart2 size={16} />, end: true },
  { to: "/admin/tickers", label: "Tickers", icon: <TrendingUp size={16} />, end: false },
  { to: "/admin/data", label: "Data Ingestion", icon: <Newspaper size={16} />, end: false },
  { to: "/admin/ai", label: "AI Quality", icon: <Bot size={16} />, end: false },
  { to: "/admin/users", label: "Users", icon: <Users size={16} />, end: false },
];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-sm opacity-50 mt-0.5">Manage your application</p>
            </div>
          </div>
